"""Signal envelope and Warning schemas (TRD §6.1/§6.2, design.md §3.1/§3.2)."""
...
class System(str, Enum):
    """Which physical system/component a signal is about (design.md §4 divergence,
    2026-07-30) — orthogonal to `source`: `predictivo` covers both `motor` and
    `transmision` rows, distinguished only by this field."""
